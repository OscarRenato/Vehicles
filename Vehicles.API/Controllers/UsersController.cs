...
namespace Vehicles.API.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> DeleteImageVehicle(int? id)
        {
            ...
            try
            {
                _imageHelper.DeleteImageAsync(vehiclePhoto.ImageId, "vehiclephotos");
            }
            catch { }
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteHistoryConfirmed(int id)
        {
            History history = await _context.Histories
                .Include(x => x.Details)
                .Include(x => x.Vehicle)
